...
// 尝试解析结果前先打印中间结果
    ...
    public void balanceOfTest(){
        ...
        funcParam.add("0x92bb0d550c3d209114a98b9fd8c67a3b129c62de");
...
// 尝试解析结果前先打印中间结果
    ...
    //初始化时间时间币数量
    @Test
    public void initial_balanceTest(){
        String userAddress = "0x925dfccfb7d2e6c1cafb7aa30acfcc2620efbc49";
...
//        funcParam.add("");
        ...
        String contractName = "P2PTime";
        String contractAddress = "0x85ac286d96fda34fc336a87a7be8fe8af7c1e9ab";
        Dict result = WEBASEUtil.funcRequest(userAddress,funcName,funcParam,contractName,contractAddress,ABI);
        System.out.println("Raw Result: " + result.toString());
...
// 尝试解析结果前先打印中间结果
     ...
     * 接受任务
     */
    public void applyVolunteerTest(){
...
// 尝试解析结果前先打印中间结果
    ...
    @Test
    public void volunteer_finishOrder(){
        String userAddress = "0xb3504aa728402067032cef0e75794e891327f0c5";
...
// 尝试解析结果前先打印中间结果
    ...
    @Test
    public void assess_volunteerTest(){
        String userAddress = "0x925dfccfb7d2e6c1cafb7aa30acfcc2620efbc49";
