      ...
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="status" label="服务状态">
          <template v-slot="scope">
            ...
            <el-tag type="info" v-if="scope.row.status === '待接受'">待接受</el-tag>
            <el-tag type="primary" v-if="scope.row.status === '已接单'">已接单</el-tag>
        ...
        <el-table-column prop="evaluate" label="订单备注"></el-table-column>
      ...
      <el-form label-width="100px" style="padding-right: 50px" :model="form">
        <el-form-item prop="status" label="订单状态">
          <el-select v-model="form.status" style="width: 100%">
            <el-option value="待接单">通过</el-option>
            <el-option value="已取消">拒绝</el-option>
          </el-select>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    load(pageNum) {  // 分页查询
      ...
      this.$request.get('/orders/selectPageExamine', {
        params: {
