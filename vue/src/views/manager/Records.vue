  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="userName" label="需求者"></el-table-column>
        <el-table-column prop="acceptName" label="志愿者"></el-table-column>
        <el-table-column prop="time" label="时间"></el-table-column>
        <el-table-column prop="type" label="类型">
          <template v-slot="scope">
            <el-tag type="primary" v-if="scope.row.type === '服务'">志愿服务</el-tag>
            <el-tag type="danger" v-if="scope.row.type === '公益'">公益活动</el-tag>
            <el-tag type="success" v-if="scope.row.type === '发放'">发放</el-tag>
          </template>
        </el-table-column>
